...
alter table agendamento_transportadoras add constraint UK_id unique (transportadoras_id);
alter table agendamento_cargas add constraint FK_cargas_agendamento_id foreign key (cargas_id) references carga (id);
alter table agendamento_cargas add constraint FK_agendamento_cargas_id foreign key (agendamento_id) references agendamento (id);
